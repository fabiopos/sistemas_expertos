;; EJERCICIO DE SISTEMAS EXPERTOS
;; 2017-05-01
;; FABIO ALONSO POSADA; JUAN CARLOS JIMENEZ; JUAN GABRIEL SARMIENTO; DORIAN TORRES
...
(defrule modelo-1       
        ...
        (test(< ?co 4.9))
        => 
        (assert (UI-control (id 1)(mensaje "El carro que usted necesita es el modelo 1")))
...
(defrule modelo-2
        ...
        => 
        (assert (UI-control (id 1)(mensaje "El carro que usted necesita es el modelo 2")))
...
(defrule modelo-3
        ...
        => 
        (assert (UI-control (id 1)(mensaje "El carro que usted necesita es el modelo 3")))
...
(defrule modelo-4
        ...
        => 
        (assert (UI-control (id 1)(mensaje "El carro que usted necesita es el modelo 4")))
...
(defrule modelo-5
        ...
        (test(> ?co 8.4))
        => 
        (assert (UI-control (id 1)(mensaje "El carro que usted necesita es el modelo 5")))
